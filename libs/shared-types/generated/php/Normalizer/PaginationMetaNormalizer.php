...
class PaginationMetaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \OpenFileSharing\Dto\Model\PaginationMeta::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \OpenFileSharing\Dto\Model\PaginationMeta::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \OpenFileSharing\Dto\Model\PaginationMeta();
    ...
    {
        return [\OpenFileSharing\Dto\Model\PaginationMeta::class => false];
    }
}